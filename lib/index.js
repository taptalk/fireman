...
module.exports = new class {
    ...
    reload() {
        ...
        const json = this._dbFile == null ? (this._in_mem_db || "{}") : fs.readFileSync(this._dbFile, 'utf8')
        flame.loadJSON(json)
    }
    ...
    save(pretty) {
        ...
        this._dbFile == null ? (this._in_mem_db = json) : fs.writeFileSync(this._dbFile, json, 'utf8')
    }
    ...
    parseRules(filename) {
        const json = filename == null ? (this._in_mem_rules || "{}") : fs.readFileSync(filename, 'utf8')
        return JSON.parse(json)
    }

    writeRules(filename, rules) {
        const json = JSON.stringify(rules, null, 2)
        filename == null ? (this._in_mem_rules = json) : fs.writeFileSync(filename, json, 'utf8')
    }
